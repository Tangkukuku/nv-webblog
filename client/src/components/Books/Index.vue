    ...
    <div class="container">
        ...
        <div class="book-header">
            ...
            <div class="create-book">
                ...
                <strong> จํานวน book: </strong> {{results.length}}
            </div>
        ...
        <transition-group name="fade">
            ...
            <div class="book-info">
                ...
                <p>
                    ...
                    <button class="btn btn-sm btn-warning" v-on:click="navigateTo('/book/edit/'+ book.id)">Edit book</button>
        ...
        <div id="book-list-bottom">
            <div class="emptybook" v-if="books.length === 0 && loading === false" >*** ไม่มีข้อมูล***</div>
            <div class="emptybook" v-if="books.length === 0 && loading === true" >*** ไม่มีข้อมูล***</div>
